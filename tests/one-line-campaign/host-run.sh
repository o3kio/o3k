...
#   curl -sfL https://github.com/o3kio/o3k/releases/download/v0.4.0-rc.3/install.sh | sudo sh -
...
BUNDLE_DIST="${O3K_CAMPAIGN_BUNDLE_DIST:-/tmp/campaign-tree/dist/o3k-0.4.0-rc.3}"
VERSION="${O3K_CAMPAIGN_VERSION:-v0.4.0-rc.3}"
