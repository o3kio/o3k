...
#
# Runs INSIDE the VM AFTER the doctor phase (v0.4.0-rc.5 installed with a
...
phase_identity_before() {
  ...
  if [ "$SOURCE_VERSION" != 0.4.0-rc.5 ]; then
    log "WARNING: expected the v0.4.0-rc.5 source install, found $SOURCE_VERSION"
  fi
