ALTER TABLE placement_providers ADD COLUMN IF NOT EXISTS parent_provider_id TEXT REFERENCES placement_providers(id);
ALTER TABLE placement_providers ADD COLUMN IF NOT EXISTS location TEXT;
