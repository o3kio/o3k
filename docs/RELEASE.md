...
branch, issuer, modified digest manifest, or missing bundle. Checksums are
integrity, not authenticity. The application/browser OIDC authority (Keycloak
in the PP.4 TestLab) is separate from GitHub's release-workload OIDC.
